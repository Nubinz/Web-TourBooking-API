<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="WEBTOURBOOKING1.Profile" %>
    ...
    <nav class="custom-navbar" data-spy="affix" data-offset-top="20">
        <div class="container">
            ...
            <ul class="nav">
                ...
                <li class="item">
                    <a class="link" href="#portfolio">Mục yêu th</a>
                </li>
                <li class="item">
        ...
        <div class="header-content container">
            ...
            <p class="header-subtitle">XINCHAOBAN!</p>
             <asp:Button ID="btnProduct" runat="server" OnClick="btnProduct_Click" Text="Sản phẩm" CssClass="btn btn-primary chudep" PostBackUrl="~/Product.aspx"/>
                <asp:Button ID="btnThoat" runat="server" OnClick="btnThoat_Click" Text="Thoát" CssClass="btn btn-primary chudep" PostBackUrl="~/Login.aspx"/>
        </div>
